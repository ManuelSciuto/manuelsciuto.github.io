...
const FlaskSvg = ({ className }: Props) => (
  <svg
    className={className}
    width="100%"
    height="100%"
  ...
  >
    <defs>
      <linearGradient
        ...
        gradientTransform="matrix(1.83697e-14,300,-300,1.83697e-14,160.554,0)"
      >
        <stop offset="0" style={{ stopColor: "#bdddeb", stopOpacity: 1 }} />
        <stop offset="1" style={{ stopColor: "#53a9d1", stopOpacity: 1 }} />
      </linearGradient>
    </defs>
